...
fprintf(1, 'Static Stability--TRex\n\n');
...
[ node_num, face_num, normal_num, ...
    ...
    = obj_display('E:\Project\zju_code\triangleMesh\make_it_stand\TRex.obj');
...
% map,       int,   2*map_num,  map surface vertex -> skeleton vertex
    [skel_node, edge, skel_face, map, skel_num, edge_num, skel_face_num, map_num] = ...
        map_reader('E:\Project\zju_code\triangleMesh\make_it_stand\TRex_copy3.obj');
...
%     pause
    ...
    offset_in_normal = 0.04;   % should be changed according to the size of object!
...
%    [alpha_in, alpha_out] = node_initialize(H, alpha_in, alpha_out, bound_in_min, bound_in_max, bound_out_min, bound_out_max);
    ...
    alpha_in = x';
    node_xyz_in = cal_node_xyz(node_xyz, alpha_in, H, offset_vector_in, node_num);
    % obj_save('E:\Project\zju_code\triangleMesh\make_it_stand\TRex_autosave_inivalue.obj',node_num,face_num,0,node_xyz_in,face_node,[],[]);
    ...
    options = optimoptions('fmincon'...
        ...
        , 'TolCon', 0.01 ...% default:1e-6 ? ;
        , 'TolX', 1e-2 ...% default:1e-10;
        );
    ...
    tic;
    x = fmincon(@(x) FUN_TRex(x, H, node_xyz, face_in, offset_vector_in, node_num, face_num, integral), ...
...
%     obj_save('E:\Project\zju_code\triangleMesh\make_it_stand\TRex_autosave_resultk200.obj',node_num,face_num,0,node_xyz_in,face_node,[],[]);
    ...
    %
    % face_in_tem = face_in + node_num;
    % obj_save('E:\Project\zju_code\triangleMesh\make_it_stand\TRex_autosave_total.obj',node_num*2,face_num*2,0,[node_xyz,node_xyz_in],[face_node,face_in],[],[]);
end
