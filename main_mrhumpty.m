...
fprintf(1, 'Static Stability--mrhumpty\n\n');
...
[ node_num, face_num, normal_num, ...
    ...
    = obj_display('E:\Project\zju_code\triangleMesh\make_it_stand\mrhumpty.obj');
...
% map,       int,   2*map_num,  map surface vertex -> skeleton vertex
    [skel_node, edge, skel_face, map, skel_num, edge_num, skel_face_num, map_num] = ...
        map_reader('E:\Project\zju_code\triangleMesh\make_it_stand\mrhumpty_copy1.obj');
...
%     pause
    ...
    offset_in_normal = 0.2;   % should be changed according to the size of object!
...
%    [alpha_in, alpha_out] = node_initialize(H, alpha_in, alpha_out, bound_in_min, bound_in_max, bound_out_min, bound_out_max);
    ...
    alpha_in = x';
    node_xyz_in = cal_node_xyz(node_xyz, alpha_in, H, offset_vector_in, node_num);
    % obj_save('E:\Project\zju_code\triangleMesh\make_it_stand\mrhumpty_autosave_inivalue.obj',node_num,face_num,0,node_xyz_in,face_node,[],[]);
